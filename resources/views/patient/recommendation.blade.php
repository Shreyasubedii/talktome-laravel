                        ...
                        <table border="0" width="80%" class="sub-table scrolldown" style="padding:50px;border:none;">
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p class="heading-sub12">Describe your symptoms or problem below, and we'll recommend the best doctors for you.</p>
                                    <br>
                                    <form method="POST" action="{{ route('patient.recommendation') }}">
                                        @csrf
                                        <textarea name="problem" rows="5" class="input-text" placeholder="e.g. I have been feeling very stressed and having trouble sleeping lately..." style="width: 100%; padding: 15px;" required>{{ $problem ?? '' }}</textarea><br><br>
                                        <input type="submit" value="Get Recommendations" class="login-btn btn-primary btn" style="width: 100%;">
                                    </form>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('patient.booking', $doc->docid) }}" class="non-style-link"><button class="btn-primary-soft btn button-icon menu-icon-session-active" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;"><font class="tn-in-text">Book Now</font></button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <tr>
                <td colspan="4">
                    <center>
                        ...
                        <p class="heading-main12" style="font-size:20px;color:rgb(49, 49, 49)">No specific matches found. Try different keywords or browse all doctors.</p>
                    </center>
                </td>
            </tr>
            @endif
