        ...
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                    <a href="{{ route('patient.schedules') }}" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Scheduled Sessions</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                ...
                <td>
                    <form action="{{ route('patient.schedules') }}" method="get" class="header-search">
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Session title or Doctor name" value="{{ $search }}">&nbsp;&nbsp;
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Scheduled Sessions ({{ $schedules->count() }})</p>
                </td>
            </tr>
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Dr. {{ $schedule->doctor?->docname }} ({{ $schedule->doctor?->specialty?->sname }})</td>
                                        <td style="text-align:center;">{{ $schedule->scheduledate }} @ {{ substr($schedule->scheduletime, 0, 5) }}</td>
                                        <td>
                                            <div style="display:flex;justify-content: center;">
                                                <a href="{{ route('patient.booking', $schedule->docid) }}" class="non-style-link"><button class="btn-primary-soft btn button-icon menu-icon-appoinment" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Book Now</font></button></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
