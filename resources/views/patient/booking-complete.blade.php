...
<div class="container">
    <div class="dash-body">
        <center>
            <div
                style="margin-top: 100px; padding: 50px; background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); width: 60%;">
                ...
                <h2 style="font-size: 50px; color: #333;">{{ str_pad($appointment->apponum, 2, '0', STR_PAD_LEFT) }}
                </h2>
                <br>
                ...
                <a href="{{ route('patient.appointments') }}" class="non-style-link"><button
                        class="login-btn btn-primary btn" style="padding: 15px 30px;">View My Bookings</button></a>
                <a href="{{ route('patient.dashboard') }}" class="non-style-link" style="margin-left: 20px;"><button
                        class="login-btn btn-primary-soft btn" style="padding: 15px 30px;">Back to
                        Dashboard</button></a>
            </div>
        </center>
    </div>
