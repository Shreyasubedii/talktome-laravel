...
<div class="container">
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                <td width="13%">
                    <a href="{{ route('admin.appointments') }}"><button
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All
                        Appointments ({{ $appointments->count() }})</p>
                </td>
            </tr>
            <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="font-weight:600;">
                                            &nbsp;{{ Str::limit($appointment->patient?->pname ?? 'Unknown Patient', 25) }}
                                        </td>
                                        <td
                                        ...
                                        <td>
                                            <div style="display:flex;justify-content: center;">
                                                <form
                                                    action="{{ route('admin.appointments.destroy', $appointment->appoid) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                                    <button type="submit"
