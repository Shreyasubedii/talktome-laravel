...
<div class="container">
    <div class="menu">
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td
                    class="menu-btn menu-icon-dashbord {{ Route::is('doctor.dashboard') ? 'menu-active menu-icon-dashbord-active' : '' }}">
                    <a href="{{ route('doctor.dashboard') }}"
                        class="non-style-link-menu {{ Route::is('doctor.dashboard') ? 'non-style-link-menu-active' : '' }}">
                        <div>
            ...
            <tr class="menu-row">
                <td
                    class="menu-btn menu-icon-appoinment {{ Route::is('doctor.appointments') ? 'menu-active menu-icon-appoinment-active' : '' }}">
                    <a href="{{ route('doctor.appointments') }}"
                        class="non-style-link-menu {{ Route::is('doctor.appointments') ? 'non-style-link-menu-active' : '' }}">
                        <div>
            ...
            <tr class="menu-row">
                <td
                    class="menu-btn menu-icon-session {{ Route::is('doctor.schedules') ? 'menu-active menu-icon-session-active' : '' }}">
            ...
            <tr class="menu-row">
                <td
                    class="menu-btn menu-icon-patient {{ Route::is('doctor.patients') ? 'menu-active menu-icon-patient-active' : '' }}">
                    <a href="{{ route('doctor.patients') }}"
                        class="non-style-link-menu {{ Route::is('doctor.patients') ? 'non-style-link-menu-active' : '' }}">
                        <div>
            ...
            <tr class="menu-row">
                <td
                    class="menu-btn menu-icon-settings {{ Route::is('doctor.settings') ? 'menu-active menu-icon-settings-active' : '' }}">
                    <a href="{{ route('doctor.settings') }}"
                        class="non-style-link-menu {{ Route::is('doctor.settings') ? 'non-style-link-menu-active' : '' }}">
                        <div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 25%;">
                                                <div class="dashboard-items"
                                                    style="padding:20px;margin:auto;width:95%;display: flex;">
                                                    <div>
                                                        <div class="h1-dashboard">{{ \App\Models\Patient::count() }}
                                                        </div><br>
                                                        <div class="h3-dashboard">All Patients
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <div class="btn-icon-back dashboard-icons"
                                                ...
                                                <div class="dashboard-items"
                                                    ...
                                                    <div>
                                                        <div class="h1-dashboard">
                                                            {{ \App\Models\Appointment::where('appodate', '>=', $today)->count() }}
                                                        </div><br>
