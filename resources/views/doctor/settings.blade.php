        ...
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-settings menu-active menu-icon-settings-active">
                    <a href="{{ route('doctor.settings') }}" class="non-style-link-menu non-style-link-menu-active">
                        <div>
            ...
            <div style="display: flex;justify-content: center;">
                <div class="abc">
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        <tr>
                            <td>
                                <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit
...
<div id="success-popup" class="overlay">
    <div class="popup">
        <center>
            ...
            <div style="display: flex;justify-content: center;">
                <a href="{{ route('doctor.settings') }}" class="non-style-link"><button
