...
<div class="container">
        ...
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-dashbord">
                    <a href="{{ route('doctor.dashboard') }}" class="non-style-link-menu"><div><p class="menu-text">Dashboard</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-appoinment">
                    <a href="{{ route('doctor.appointments') }}" class="non-style-link-menu"><div><p class="menu-text">My Appointments</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-session">
                    <a href="{{ route('doctor.schedules') }}" class="non-style-link-menu"><div><p class="menu-text">My Sessions</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-patient">
                    <a href="{{ route('doctor.patients') }}" class="non-style-link-menu"><div><p class="menu-text">My Patients</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-settings menu-active menu-icon-settings-active">
                    <a href="{{ route('doctor.settings') }}" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Settings</p></div></a>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="dash-body" style="margin-top: 15px">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
            <tr>
                <td width="13%" >
                    <a href="{{ route('doctor.dashboard') }}" ><button class="login-btn btn-primary-soft btn btn-icon-back" style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                </td>
                <td>
...
{{-- Edit Popup --}}
<div id="edit-popup" class="overlay" style="display: {{ session('success') ? 'none' : (request('action') == 'edit' ? 'block' : 'none') }};">
    <div class="popup">
        <center>
            ...
            <div style="display: flex;justify-content: center;">
                <div class="abc">
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        <tr>
                            <td>
                                <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Account Details.</p><br>
                            </td>
                        </tr>
                        <form action="{{ route('doctor.settings.update') }}" method="POST">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <input type="text" name="name" class="input-text" value="{{ $doctor->docname }}" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="tel" class="form-label">Telephone: </label>
                                    <input type="tel" name="tel" class="input-text" value="{{ $doctor->docter }}" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
        ...
        <center>
            ...
            <div style="display: flex;justify-content: center;">
                <table width="80%" class="sub-table scrolldown" border="0">
                    ...
                    <tr>
                        <td class="label-td"><label class="form-label">Specialty: </label></td>
                        <td>{{ $doctor->specialty?->sname }}</td>
                    </tr>
                </table>
            </div>
        </center>
...
<div id="success-popup" class="overlay">
    <div class="popup">
        <center>
            ...
            <a class="close" href="{{ route('doctor.settings') }}">&times;</a>
            <div class="content">Your profile information has been updated.</div>
            <div style="display: flex;justify-content: center;">
                <a href="{{ route('doctor.settings') }}" class="non-style-link"><button class="btn-primary btn">OK</button></a>
            </div>
            <br><br>
        </center>
    </div>
